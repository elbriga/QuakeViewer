...
void grafico_desenha_objeto(obj3d_t *obj, int numFrameSel, char paleta[256][3])
{
	...
	for (int cnt_tri=0; cnt_tri<obj->numtris; cnt_tri++) {
		...
		grafico_triangulo(vertice1->x, vertice1->y, vertice2->x, vertice2->y, vertice3->x, vertice3->y, 250, 200, 200);
		grafico_triangulo(vertice1->y+260, 255-vertice1->z, vertice2->y+260, 255-vertice2->z, vertice3->y+260, 255-vertice3->z, 250, 200, 200);
		grafico_triangulo(vertice1->x, (255-vertice1->z)+260, vertice2->x, (255-vertice2->z)+260, vertice3->x, (255-vertice3->z)+260, 250, 200, 200);
	}
